        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "#888888")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@fatfood.com", "Admin", "10000.Z1FNrs/GY4CFMywt68yWEw==.RuWCjjK60nHUGq3oKFTpjFX6vsHwYx9bNmms/aJDcZM=" },
                    { 2, "user@fatfood.com", "User", "10000.YVilgQmeQ/LDdg1VcFmQ8Q==.0y8t2NPmn6wBOdpLVF5pAQfwqQesj5uYEwPt0mRPgiI=" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CreatedAt", "Status", "TotalPrice", "UserId" },
                values: new object[] { 1, new DateTime(2024, 5, 12, 0, 0, 0, 0, DateTimeKind.Utc), "COMPLETED", 56.00m, 2 });
